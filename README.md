...
When user uploads a [transcodes](transcodes-and-spectral-analysis/#transcodes), [stretched files](how-to-fill-in-upload-with-correct-meta-data/) \(traxdb\), irrelevant music \(what's not related to minimal/deep\), he suppose to label these files himself to avoid be fined \(possible via [roboard](https://romnml.rv7.ru/)\).
